...
//        let textAttributes = [NSAttributedString.Key.font.rawValue: font!, NSAttributedString.Key.foregroundColor: UIColor(red: 243.0/255, green: 82.0/255.0, blue: 30.0/255.0, alpha: 1.0), NSAttributedString.Key.kern: 7.5] as? [String : Any]
//
...
//            testLabel.attributedText = NSAttributedString(string: text, attributes: nil)
//        }
//        else {
//            testLabel.text = text
//            //testLabel.font = font!
